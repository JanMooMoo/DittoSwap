...
class App extends Component {
  ...
  async loadDay(){ 
      ...
      this.setState({
        ...
        this.setState({fromBlock:this.state.competitionStartBlock,toBlock:this.state.competitionEndBlock,lastKnownBlock:currentBlock })
